...
module Common {
    import DiagramJsonParser = EditorCore.DiagramJsonParser;
    import DiagramParts = EditorCore.DiagramParts;
    import NodeType = EditorCore.NodeType;
    import DiagramNode = EditorCore.DiagramNode;
    import Property = EditorCore.Property;
    import DefaultDiagramNode = EditorCore.DefaultDiagramNode;
    import Link = EditorCore.Link;
    export class DiagramThriftParser extends DiagramJsonParser {

        public parse(diagram: TDiagram, nodeTypesMap: Map<String, NodeType>): DiagramParts {
