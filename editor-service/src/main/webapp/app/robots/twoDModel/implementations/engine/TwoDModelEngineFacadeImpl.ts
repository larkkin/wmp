...
module Robots {
    export class TwoDModelEngineFacadeImpl implements TwoDModelEngineFacade {
        ...
        constructor($scope, $compile, $attrs) {
            ...
            $scope.setDrawLineMode = () => {
                this.setDrawLineMode();
            };
            $scope.setDrawWallMode = () => {
                this.setDrawWallMode();
            };
            $scope.setDrawPencilMode = () => {
                this.setDrawPencilMode();
            };
            $scope.setDrawEllipseMode = () => {
                this.setDrawEllipseMode();
            };
            $scope.setNoneMode = () => {
                this.setNoneMode();
            };
    ...
    angular.module("Robots").controller("TwoDModelEngineFacadeImpl", TwoDModelEngineFacadeImpl);
