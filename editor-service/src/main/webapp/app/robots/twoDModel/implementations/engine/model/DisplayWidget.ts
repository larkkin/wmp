...
module Robots {
    export class DisplayWidget {
        ...
        constructor() {
            ...
            this.smileImg.src = Common.GeneralConstants.APP_ROOT_PATH + "images/2dmodel/trikKit/smile.png";
            this.sadSmileImg = new Image();
            this.sadSmileImg.src = Common.GeneralConstants.APP_ROOT_PATH + "images/2dmodel/trikKit/sadSmile.png";
