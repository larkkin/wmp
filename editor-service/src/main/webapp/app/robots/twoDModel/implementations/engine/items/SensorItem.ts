    ...
    export class SensorItem {
        ...
        setStartPosition() {
            ...
            this.rotationHandle.attr({
                "cx": +this.startPosition.x + this.width + 20,
                "cy": this.startPosition.y + this.height / 2
            });
        ...
        pathToImage(): string {
            return Common.GeneralConstants.APP_ROOT_PATH + "images/2dmodel/sensors/2d_" + this.name() + ".png";
        }
